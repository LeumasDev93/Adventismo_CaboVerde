    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 shadow-lg border-b border-gray-700 bg-gray-900 text-gray-100 transition-all duration-300 hidden sm:block p-6 lg:p-8">
        <div className="flex items-center justify-center gap-4 xl:gap-8">
          <div className="relative">
            <div className="bg-gray-800 rounded-full flex items-center justify-center shadow-lg border-2 overflow-hidden relative w-16 h-16 xl:w-24 xl:h-24">
              <Image
                src={LogoTemaEscura}
                alt="Logo História do Adventismo - Tema Escuro"
                width={100}
          ...
          <div className="text-center">
            <h1 className="font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent text-3xl xl:text-4xl">
              O que dizer dos adventistas em Cabo Verde
            </h1>
            <p className="w-[80%] mx-auto text-sm xl:text-lg mt-2 text-center text-gray-300">
